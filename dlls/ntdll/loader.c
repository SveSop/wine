...
void WINAPI LdrInitializeThunk( CONTEXT *context, ULONG_PTR unknown2, ULONG_PTR unknown3, ULONG_PTR unknown4 )
{
    ...
    {
        FIXME_(winediag)("cybwine-fastsync %s is a testing version containing HIGHLY experimental patches.\n", wine_get_version());
        FIXME_(winediag)("Please do NOT report any errors with this version.\n");
    }
    else
        WARN_(winediag)("cybwine-fastsync %s is a testing version containing HIGHLY experimental patches.\n", wine_get_version());
